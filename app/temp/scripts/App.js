...
/***/ (function(module, exports, __webpack_require__) {
	...
	new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%"); /* example instances of a 'recyclable' module */
	  ...
	  _createClass(RevealOnScroll, [{
	    ...
	    value: function createWaypoints() {
	      ...
	      this.itemsToReveal.each(function () {
	        /* 'each' is a jQuery method - Do something for each */
